    ...
    <body class="fixed-left">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="form-inline page-box">
                                <!-- LOGIN FORM -->
                                <form role="form" method="post" action="update-user-data.php" onsubmit="update();">
                                    ...
                                    <div class="form-button">
                                        <input type="submit" class="btn sinfra-btn send m-t-20" value="Atualizar">
                                    </div>
                                </form>
                            </div>
						</div>
        ...
        <script type="text/javascript">
            ...
            function update() {
                ...
                xhttp.open("GET", "update-user-data.php", true);
                xhttp.send();
            }
        </script>
    </body>
